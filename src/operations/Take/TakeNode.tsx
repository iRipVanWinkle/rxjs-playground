...
import IntervalForm from "./TakeForm";

export default function TakeNode(props: NodeProps<TakeNodeType>) {
  const { id, data } = props;

  return (
    <NodeContainer {...props}>
      <NodeHeader id={id} name="take()" editForm={<IntervalForm />}></NodeHeader>
